...
class TestBoardPrivateMethods(unittest.TestCase):
    ...
    def test_can_bear_off_from_exact_and_higher_die(self):
        """Cubre __can_bear_off_from__ con exacto y dado alto - CORREGIDO"""
        b = self.board
        ...
        # Test 2: Dado alto CON fichas más lejanas (no se puede sacar)
        # Limpiar el tablero y poner fichas específicas
        for i in range(24):
            b.__points__[i] = None
        
        b.__points__[0] = {"color": "white", "count": 1}  # Ficha en punto 0
        b.__points__[4] = {"color": "white", "count": 1}  # Ficha más lejana en punto 4
        
        # Dado 6 desde punto 0: 0 - 6 = -6 < -1, pero hay fichas en punto 4
        self.assertFalse(b.__can_bear_off_from__(0, 6, "white", -1))
        
        # Test 3: Dado alto SIN fichas más lejanas (sí se puede sacar)
        b.__points__[4] = None  # Eliminamos la ficha lejana
        b.__points__[0] = {"color": "white", "count": 1}
        
        # Ahora sí debería poder sacar con dado alto
        ...
        b.__points__[23] = {"color": "black", "count": 1}
        b.__points__[19] = None  # Sin fichas más cerca del inicio
...
class TestBoardCoverageImprovements(unittest.TestCase):
    ...
    def test_can_bear_off_black_with_closer_checkers(self):
        """Cubre línea 311-313: negras con fichas más cercanas"""
        b = Board()
        for i in range(24):
            b.__points__[i] = None
        ...
        # Ficha en punto 23
        b.__points__[23] = {"color": "black", "count": 1}
        # Ficha más cerca (punto menor) en 20
        b.__points__[20] = {"color": "black", "count": 1}
        
        # No debería poder sacar con dado alto (6) porque hay fichas más cerca
        self.assertFalse(b.__can_bear_off_from__(23, 6, "black", 1))

    def test_can_bear_off_white_with_farther_checkers(self):
        """Cubre línea 297-299: blancas con fichas más lejanas"""
        b = Board()
        for i in range(24):
            b.__points__[i] = None
        ...
        # Ficha en punto 0
        b.__points__[0] = {"color": "white", "count": 1}
        # Ficha más lejos (punto mayor) en 3
        b.__points__[3] = {"color": "white", "count": 1}
        
        # No debería poder sacar con dado alto (6) porque hay fichas más lejos
        self.assertFalse(b.__can_bear_off_from__(0, 6, "white", -1))
